    ...
    <div className="container m-auto  px-2 " id="about">
      <div className="flex items-center justify-center -z-50 gap-16 flex-col lg:flex-row">
        ...
        <div className="flex-1">
          ...
          <div>
            <p className="text-lg md:text-2xl lg:text-2xl py-2 text-gray-500">
            ...
            <p className="text-lg md:text-2xl lg:text-2xl text-gray-500">
          ...
          <div className="py-10">
            ...
            <a href="contact">
              <button className="btn border-0 text-xl md:text-2xl lg:text-2xl bg-deep-orange-600 text-white hover:bg-[#122025] rounded-md">
                Hire Me
