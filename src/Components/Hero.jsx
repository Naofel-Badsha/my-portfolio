      ...
      <div className="flex items-center justify-between gap-12 flex-col lg:flex-row-reverse">
        ...
        <div className="flex-1 mt-10 px-2" data-aos="fade-right">
          ...
          <h3 className="text-3xl md:text-4xl lg:text-4xl text-white font-bold">
            On a{" "}
            <span className="text-3xl md:text-4xl lg:text-4xl text-deep-orange-700">
              {text}
            </span>{" "}
          </h3>
          <p className="py-8 text-lg md:text-xl lg:text-2xl text-gray-500">
          ...
          <div>
            <div className="flex gap-5">
              <a href="https://www.facebook.com/profile.php?id=61550632539237">
                <i className="fa-brands fa-facebook text-3xl md:text-4xl lg:text-4xl text-deep-orange-700 hover:text-white hover:-translate-y-2 duration-75 delay-100"></i>
              </a>
              <a href="https://x.com/NaofelMd25125">
                <i className="fa-brands fa-twitter text-3xl md:text-4xl lg:text-4xl ml-3 text-deep-orange-700 hover:text-white hover:-translate-y-2 duration-75 delay-100"></i>
              </a>
              <a href="https://www.linkedin.com/in/md-naofel-badsha">
                <i className="fa-brands fa-linkedin text-3xl md:text-4xl lg:text-4xl ml-3 text-deep-orange-700 hover:text-white hover:-translate-y-2 duration-75 delay-100"></i>
              </a>
              <a href="https://www.instagram.com/naofelbadsha007">
                <i className="fa-brands fa-instagram text-3xl md:text-4xl lg:text-4xl ml-3 text-deep-orange-700 hover:text-white hover:-translate-y-2 duration-75 delay-100"></i>
              </a>
            </div>
          </div>
          <div className="py-10">
