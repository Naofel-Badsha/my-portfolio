      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 py-20">
        ...
        <div className="p-6 shadowOne rounded-lg shadow">
          <div className="text-center">
            <div className="flex items-center justify-center  bg-deep-orange-700 text-white  w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full m-auto">
        ...
        <div className="p-6 shadowOne rounded-lg shadow">
          <div className="text-center">
            <div className="flex items-center justify-center  bg-deep-orange-700 text-white w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full m-auto">
              <i className="fa-solid fa-server text-2xl md:text-3xl lg:text-3xl text-white p-3"></i>
            </div>
