  ...
  return (
    <div className="container m-auto px-2" id="services">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 py-20">
        {/*-------------Services--------1---------*/}
        <div className="p-6 shadowOne rounded-lg shadow hover:bg-[#122025] border-0 hover:border-[1px] duration-200">
          <div className="text-center">
            ...
            <h1 className="text-4xl text-white font-medium md:font-bold lg:font-bold py-3 mt-3">
              Responsive
            </h1>
            ...
            <div className="py-5">
              <a href="contact">
                <button className="btn border-0 bg-deep-orange-700 text-white hover:bg-[#122025] hover:ml-2 text-lg md:text-xl lg:text-xl rounded-lg hover:border-[2px]">
                  Seay Hello <i className="fa-solid fa-arrow-right mt-1"></i>
                </button>
              </a>
            </div>
          </div>
